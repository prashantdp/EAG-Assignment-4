    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                print("-----------------------")
                system_prompt = f"""
                You are an agent controlling Apple Keynote on macOS. You have access to tools to interact with Keynote.
                ...
                - For functions with no parameters, STRICTLY call the function using only the function_name (e.g., FUNCTION_CALL: open_keynote)
                ...
                - Do not imagine tools that are not listed.
                - Call `open_keynote` first if Keynote isn't open.
                - Call `create_blank_keynote_slide` before drawing or adding text if you're not sure a usable slide exists.
